...
s32 func_8002DF54(PlayState* play, Player* player, Actor* actor, u8 arg2);
void func_8002DF90(DynaPolyActor* dynaActor);
void func_8002DFA4(DynaPolyActor* dynaActor, f32 arg1, s16 arg2);
s32 Player_IsFacingActor(Actor* actor, s16 angle, Player* player, PlayState* play);
s32 Actor_ActorBIsFacingActorA(Actor* actorA, Actor* actorB, s16 angle);
s32 Actor_IsFacingPlayer(Actor* actor, s16 angle, Player* player, PlayState* play);
s32 Actor_ActorAIsFacingActorB(Actor* actorA, Actor* actorB, s16 angle);
s32 Actor_IsFacingAndNearPlayer(Actor* actor, f32 range, s16 angle, Player* player, PlayState* play);
...
s32 func_8002F0C8(Actor* actor, PlayState* play, Player* player, s32 arg2);
...
s16 OnePointCutscene_Init(PlayState* play, Player* player, s16 csId, s16 timer, Actor* actor, s16 camIdx);
...
s32 OnePointCutscene_CheckForCategory(PlayState* play, Player* player, s32 actorCategory);
...
s32 Player_InCsMode(PlayState* play, Player* player);
...
s32 Player_IsBurningStickInRange(PlayState* play, Player* this, Vec3f* pos, f32 radius, f32 arg3);
...
s32 Play_CameraChangeSetting(PlayState* play, Player* player, s16 camId, s16 arg2);
