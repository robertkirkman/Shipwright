...
s32 OnePointCutscene_SetInfo(PlayState* play, Player* player, s16 camIdx, s16 csId, Actor* actor, s16 timer) {
    u16 playerIndex = Player_GetIndex(player, play);
    Camera* csCam = play->cameraPtrs[playerIndex][camIdx];
    Camera* childCam = play->cameraPtrs[playerIndex][csCam->childCamIdx];
    Camera* mainCam = play->cameraPtrs[playerIndex][MAIN_CAM];
    VecSph spD0;
    s32 i;
    Vec3f spC0;
    Vec3f spB4;
    ...
    switch (csId) {
        case 1020:
            ...
            D_801208EC[0].atTargetInit = play->views[playerIndex].lookAt;
            D_801208EC[0].eyeTargetInit = play->views[playerIndex].eye;
            D_801208EC[0].fovTargetInit = play->views[playerIndex].fovy;
            ...
            break;
        case 1030:
            D_80120964[0].atTargetInit = play->views[playerIndex].lookAt;
            D_80120964[0].eyeTargetInit = play->views[playerIndex].eye;
            D_80120964[0].fovTargetInit = play->views[playerIndex].fovy;
            ...
            break;
        case 5000:
            D_801209B4[0].atTargetInit = D_801209B4[1].atTargetInit = play->views[playerIndex].lookAt;
            D_801209B4[0].eyeTargetInit = play->views[playerIndex].eye;
            D_801209B4[0].fovTargetInit = D_801209B4[2].fovTargetInit = play->views[playerIndex].fovy;
        ...
        case 5010:
            ...
            Play_CameraSetAtEye(play, player, camIdx, &mainCam->at, &mainCam->eye);
            csCam->roll = 0;
            break;
        case 9500:
        ...
        case 2200: {
            ...
            if ((sp82 > 0) && (sp82 < 320) && (sp7E > 0) && (sp7E < 240) && (sp80 > 0) && (sp80 < 320) && (sp7C > 0) &&
                ...
                D_80121184[0].atTargetInit.x = (play->views[0].lookAt.x + actor->focus.pos.x) * 0.5f;
                D_80121184[0].atTargetInit.y = (play->views[0].lookAt.y + actor->focus.pos.y) * 0.5f;
                D_80121184[0].atTargetInit.z = (play->views[0].lookAt.z + actor->focus.pos.z) * 0.5f;
                D_80121184[0].eyeTargetInit = play->views[playerIndex].eye;
        ...
        case 4500:
            ...
            Play_CameraChangeSetting(play, player, camIdx, CAM_SET_FREE2);
            Play_CameraSetAtEye(play, player, camIdx, &spC0, &spB4);
            func_8002DF54(play, player, NULL, 8);
            csCam->roll = 0;
            csCam->fov = 50.0f;
            if (csCam->childCamIdx != SUBCAM_FREE) {
                OnePointCutscene_EndCutscene(play, player, csCam->childCamIdx);
            }
            break;
        case 2210:
        ...
        case 1010:
            Play_CameraChangeSetting(play, player, camIdx, CAM_SET_FREE2);
            Play_CameraSetAtEye(play, player, camIdx, &childCam->at, &childCam->eye);
            Play_CameraSetFov(play, player, camIdx, childCam->fov);
            Play_SetCameraRoll(play, player, camIdx, childCam->roll);
            break;
        case 9601:
            Play_CameraChangeSetting(play, player, camIdx, CAM_SET_CS_3);
            Play_CameraChangeSetting(play, player, MAIN_CAM, mainCam->prevSetting);
        ...
        case 3050:
            Play_CameraChangeSetting(play, player, camIdx, CAM_SET_CS_3);
            func_8002DF54(play, player, &player->actor, 5);
        ...
        case 3130:
            ...
            break;
        case 3140:
            D_80121C24[0].atTargetInit = play->views[playerIndex].lookAt;
            D_80121C24[0].eyeTargetInit = play->views[playerIndex].eye;
            D_80121C24[0].fovTargetInit = play->views[playerIndex].fovy;
        ...
        case 3150:
            ...
            csCam->roll = 0x50;
            csCam->fov = 55.0f;
            func_8002DF38(play, player, &player->actor, 8);
            break;
        case 3170:
            ...
            Play_CameraChangeSetting(play, player, camIdx, CAM_SET_FREE2);
            Play_CameraSetAtEye(play, player, camIdx, &spC0, &spB4);
            Play_CopyCamera(play, player, MAIN_CAM, camIdx);
            csCam->roll = -1;
            csCam->fov = 55.0f;
        ...
        case 3180:
            ...
            break;
        case 3190:
            Play_CameraChangeSetting(play, player, camIdx, CAM_SET_FOREST_DEFEAT_POE);
            Camera_ChangeMode(mainCam, CAM_MODE_NORMAL);
            func_8002DF38(play, player, actor, 0xC);
            break;
        case 3230:
            spC0.x = 120.0f;
            spC0.y = 265.0f;
            ...
            spD0.r = 120.0f;
            OnePointCutscene_AddVecSphToVec3f(&spB4, &spC0, &spD0);
            Play_CameraSetAtEye(play, player, MAIN_CAM, &spC0, &spB4);
        ...
        case 3390:
            ...
            break;
        case 3310:
            Play_CameraChangeSetting(play, player, camIdx, CAM_SET_FIRE_STAIRCASE);
            func_8002DF54(play, player, NULL, 8);
            Play_CopyCamera(play, player, camIdx, MAIN_CAM);
            ...
            break;
        case 3290:
            D_80121F1C[0].atTargetInit = play->views[playerIndex].lookAt;
            D_80121F1C[0].eyeTargetInit = play->views[playerIndex].eye;
            D_80121F1C[0].fovTargetInit = play->views[playerIndex].fovy;
            Actor_GetFocus(&spA0, actor);
            ...
            break;
        case 3340:
            D_80121FBC[0].atTargetInit = play->views[playerIndex].lookAt;
            D_80121FBC[0].eyeTargetInit = play->views[playerIndex].eye;
            D_80121FBC[0].fovTargetInit = play->views[playerIndex].fovy;
        ...
        case 3360:
            ...
            break;
        case 3350:
            D_801220D4[0].atTargetInit = play->views[playerIndex].lookAt;
            D_801220D4[0].eyeTargetInit = play->views[playerIndex].eye;
            D_801220D4[0].fovTargetInit = play->views[playerIndex].fovy;
        ...
        case 4220:
            ...
            func_800C0808(play, camIdx, player, CAM_SET_CS_C);
            func_8002DF38(play, player, &player->actor, 1);
        ...
        case 9908:
            ...
            break;
        case 1000:
            D_801232A4[0].atTargetInit = play->views[playerIndex].lookAt;
            D_801232A4[0].eyeTargetInit = play->views[playerIndex].eye;
            D_801232A4[0].fovTargetInit = play->views[playerIndex].fovy;
        ...
        case 4022:
            ...
            break;
        case 9703:
            D_80123894[0].atTargetInit = play->views[playerIndex].lookAt;
            D_80123894[0].eyeTargetInit = play->views[playerIndex].eye;
            D_80123894[0].fovTargetInit = play->views[playerIndex].fovy;
            if (LINK_IS_ADULT) {
            ...
            break;
        case 9704:
            D_8012390C[0].atTargetInit = play->views[playerIndex].lookAt;
            D_8012390C[0].eyeTargetInit = play->views[playerIndex].eye;
            D_8012390C[0].fovTargetInit = play->views[playerIndex].fovy;
            ...
            break;
        case 9705:
            D_8012395C[0].atTargetInit = play->views[playerIndex].lookAt;
            D_8012395C[0].eyeTargetInit = play->views[playerIndex].eye;
            D_8012395C[0].fovTargetInit = play->views[playerIndex].fovy;
...
s16 OnePointCutscene_SetAsChild(PlayState* play, Player* player, s16 newCamIdx, s16 parentCamIdx) {
    u16 playerIndex = Player_GetIndex(player, play);
    s16 prevCamIdx = play->cameraPtrs[playerIndex][parentCamIdx]->childCamIdx;

    play->cameraPtrs[playerIndex][newCamIdx]->parentCamIdx = parentCamIdx;
    play->cameraPtrs[playerIndex][parentCamIdx]->childCamIdx = newCamIdx;
 ...
 * SUBCAM_NONE
 */
s32 OnePointCutscene_RemoveCamera(PlayState* play, Player* player, s16 camIdx) {
    u16 playerIndex = Player_GetIndex(player, play);
    Camera* camera = play->cameraPtrs[playerIndex][camIdx];
    s32 nextCamIdx;

    if (camera->thisIdx == CHILD_CAM(camera, playerIndex)->parentCamIdx) {
        CHILD_CAM(camera, playerIndex)->parentCamIdx = camera->parentCamIdx;
    }
    if (camera->thisIdx == PARENT_CAM(camera, playerIndex)->childCamIdx) {
        PARENT_CAM(camera, playerIndex)->childCamIdx = camera->childCamIdx;
    }
    nextCamIdx = (play->activeCameras[playerIndex] == camIdx) ? camera->parentCamIdx : SUBCAM_NONE;
    camera->parentCamIdx = MAIN_CAM;
    camera->childCamIdx = camera->parentCamIdx;
    camera->timer = -1;
    Play_ClearCamera(camera->play, player, camera->thisIdx);
    return nextCamIdx;
}
 ...
 * queue.
 */
s16 OnePointCutscene_Init(PlayState* play, Player* player, s16 csId, s16 timer, Actor* actor, s16 parentCamIdx) {
    u16 playerIndex = Player_GetIndex(player, play);
    s16 temp1;
    s16 temp2;
    s16 csCamIdx;
    ...
    if (parentCamIdx == SUBCAM_ACTIVE) {
        parentCamIdx = play->activeCameras[playerIndex];
    }
    csCamIdx = Play_CreateSubCamera(play, player);
    ...
    vChildCamIdx = play->cameraPtrs[playerIndex][parentCamIdx]->childCamIdx;
    vCsStatus = CAM_STAT_ACTIVE;
    if (vChildCamIdx >= SUBCAM_FIRST) {
        OnePointCutscene_SetAsChild(play, player, vChildCamIdx, csCamIdx);
        vCsStatus = CAM_STAT_WAIT;
    } else {
        Interface_ChangeAlpha(2);
    }
    OnePointCutscene_SetAsChild(play, player, csCamIdx, parentCamIdx);

    csCam = play->cameraPtrs[playerIndex][csCamIdx];

    csCam->timer = timer;
    csCam->target = actor;

    csCam->at = play->views[playerIndex].lookAt;
    csCam->eye = play->views[playerIndex].eye;
    csCam->fov = play->views[playerIndex].fovy;

    csCam->csId = csId;

    if (parentCamIdx == MAIN_CAM) {
        Play_ChangeCameraStatus(play, player, parentCamIdx, CAM_STAT_UNK3);
    } else {
        Play_ChangeCameraStatus(play, player, parentCamIdx, CAM_STAT_WAIT);
    }
    OnePointCutscene_SetInfo(play, player, csCamIdx, csId, actor, timer);
    Play_ChangeCameraStatus(play, player, csCamIdx, vCsStatus);

    // Removes all lower priority cutscenes in front of this cutscene from the queue.
    vCurCamIdx = csCamIdx;
    vNextCamIdx = play->cameraPtrs[playerIndex][csCamIdx]->childCamIdx;

    while (vNextCamIdx >= SUBCAM_FIRST) {
        s16 nextCsId = play->cameraPtrs[playerIndex][vNextCamIdx]->csId;
        s16 thisCsId = play->cameraPtrs[playerIndex][csCamIdx]->csId;
        ...
        if ((nextCsId / 100) < (thisCsId / 100)) {
            ...
            if (play->cameraPtrs[playerIndex][vNextCamIdx]->csId != 5010) {
                if ((vNextCamIdx = OnePointCutscene_RemoveCamera(play, player, vNextCamIdx)) != SUBCAM_NONE) {
                    Play_ChangeCameraStatus(play, player, vNextCamIdx, CAM_STAT_ACTIVE);
                }
            } else {
                vCurCamIdx = vNextCamIdx;
                OnePointCutscene_EndCutscene(play, player, vNextCamIdx);
            }
        } else {
            vCurCamIdx = vNextCamIdx;
        }
        vNextCamIdx = play->cameraPtrs[playerIndex][vCurCamIdx]->childCamIdx;
    }
    return csCamIdx;
}
 ...
 */
s16 OnePointCutscene_EndCutscene(PlayState* play, Player* player, s16 camIdx) {
    u16 playerIndex = Player_GetIndex(player, play);
    if (camIdx == SUBCAM_ACTIVE) {
        camIdx = play->activeCameras[playerIndex];
    }
    if (play->cameraPtrs[playerIndex][camIdx] != NULL) {
        osSyncPrintf("onepointdemo camera[%d]: delete timer=%d next=%d\n", camIdx, play->cameraPtrs[playerIndex][camIdx]->timer,
                     play->cameraPtrs[playerIndex][camIdx]->parentCamIdx);
        if (play->cameraPtrs[playerIndex][camIdx]->csId == 5010) {
            play->cameraPtrs[playerIndex][camIdx]->timer = 5;
        } else {
            play->cameraPtrs[playerIndex][camIdx]->timer = 0;
        }
    }
    return camIdx;
}
 ...
 */
s32 OnePointCutscene_Attention(PlayState* play, Player* player, Actor* actor) {
    u16 playerIndex = Player_GetIndex(player, play);
    Camera* parentCam;
    s32 temp1;
    s32 temp2;
    ...
    parentCam = play->cameraPtrs[playerIndex][MAIN_CAM];
    ...
    while (parentCam->childCamIdx != SUBCAM_FREE) {
        parentCam = play->cameraPtrs[playerIndex][parentCam->childCamIdx];
        if (parentCam == NULL) {
            break;
    ...
    vCsCamIdx = OnePointCutscene_Init(play, player, 5010, timer, actor, vParentCamIdx);
    if (vCsCamIdx == SUBCAM_NONE) {
        osSyncPrintf(VT_COL(RED, WHITE) "actor attention demo: give up! \n" VT_RST, actor->id);
        return SUBCAM_NONE;
    } else {
        s32* data = (s32*)&play->cameraPtrs[playerIndex][vCsCamIdx]->data1;
 ...
 */
s32 OnePointCutscene_AttentionSetSfx(PlayState* play, Player* player, Actor* actor, s32 sfxId) {
    u16 playerIndex = Player_GetIndex(player, play);
    s32 csCamIdx = OnePointCutscene_Attention(play, player, actor);

    if (csCamIdx != SUBCAM_NONE) {
        s32* data = (s32*)&play->cameraPtrs[playerIndex][csCamIdx]->data1;
...
s32 OnePointCutscene_CheckForCategory(PlayState* play, Player* player, s32 category) {
    u16 playerIndex = Player_GetIndex(player, play);
    Camera* parentCam = play->cameraPtrs[playerIndex][MAIN_CAM];
